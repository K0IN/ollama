...
execute_process(
  COMMAND "/usr/bin/git" show-ref "master-c9c74b4"
  WORKING_DIRECTORY "/mnt/e/src/ollama-2/llm/generate/build/_deps/llama-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "master-c9c74b4")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("master-c9c74b4" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/master-c9c74b4")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/mnt/e/src/ollama-2/llm/generate/build/_deps/llama-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/mnt/e/src/ollama-2/llm/generate/build/_deps/llama-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
